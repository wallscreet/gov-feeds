...
export default async function RegulatoryPolicy() {
  ...
  return (
    <div className="container mx-auto p-4">
        <h1 className="text-center text-xl tracking-widest text-[#355e93] uppercase mb-2">US Department of Labor</h1>
        <h1 className="text-center text-xl tracking-widest text-[#355e93] uppercase">National and Regional News Releases</h1>
