...
export default async function FedsNotes() {
  ...
  return (
    <div className="container mx-auto p-4 pt-24">
      ...
      <h1 className="text-center text-xl tracking-widest text-[#355e93] uppercase">FEDS Notes</h1>
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 pt-6">
        {items.map((item, index) => (
          <div key={index} className="bg-gray-100 border border-slate-200 shadow-lg rounded-lg p-4">
            ...
            <p className="text-[#355e93] mb-4">{item.description[0].substring(0, 690)}...</p>
