...
export default async function Home() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-center text-xl tracking-widest text-gray-700 uppercase mb-2">US Federal Reserve</h1>
      <h1 className="text-center text-xl tracking-widest text-gray-700 uppercase">All Speeches and Testimony</h1>
