...
export default async function Home() {
  ...
  return (
    <div className="container mx-auto p-4 pt-24">
      <h1 className="text-center text-xl tracking-widest text-[#355e93] uppercase mb-2">US Federal Reserve</h1>
      <h1 className="text-center text-xl tracking-widest text-[#355e93] uppercase">All Speeches and Testimony</h1>
