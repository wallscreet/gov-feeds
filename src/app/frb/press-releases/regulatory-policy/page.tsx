...
export default async function RegulatoryPolicy() {
  ...
  return (
    <div className="container mx-auto p-4">
        ...
        <h1 className="text-center text-xl tracking-widest text-[#355e93] uppercase">Banking and Consumer Regulatory Policy</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 pt-6">
            {items.map((item, index) => (
                ...
                <a href={item.link[0]} target="_blank" rel="noopener noreferrer" className="text-[#355e93] hover:underline">Read more</a>
            </div>
        ))}
        </div>
    </div>
